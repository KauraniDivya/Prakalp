...
const ColorMapping3 = () => {
  ...
  useEffect(() => {
    const fetchTopUniversities = async () => {
      try {
        const response = await fetch('/top-states-by-average-project-views');
  ...
  return (
    <div className="m-4 md:m-10 mt-24 p-10 bg-blue-50 dark:bg-secondary-dark-bg rounded-3xl fixed" style={{width:'1050px'}}>
      <ChartsHeader category="Color Mapping" title="Top States based on views" />
      <div style={{width:'950px'}} >
        <ChartComponent
          ...
          legendSettings={{ mode: 'Range', background: '#f2edff' }}
          tooltip={{ enable: true }}
          background="#f2edff"
          height="400"
        >
